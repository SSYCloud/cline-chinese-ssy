...
/**
 * ClineLogoPanda component renders the Cline logo with automatic theme adaptation
 ...
 */
const ClineLogoPanda = (props: SVGProps<SVGSVGElement> & { environment?: Environment }) => {
	...
	return (
		<svg
			...
			<g>
				<path
					className="st0"
					d="M194.452,185.679c-23.344-4.381-39.892,3.62-65.28,36.261c-25.385,32.634-16.921,82.195,26.598,83.405
				c36.271,1.005,50.77-33.85,59.231-59.228C226.998,210.127,213.792,189.299,194.452,185.679z"
				/>
				<path
					className="st0"
					d="M312.616,184.293c-22.963,9.673-27.708,25.664-15.715,61.66c8.464,25.378,22.966,60.24,59.234,59.221
				c43.516-1.21,51.98-50.771,26.594-83.404C357.344,189.123,335.586,174.627,312.616,184.293z"
				/>
				<path
					className="st0"
					d="M512,98.634c0-40.269-32.64-72.91-72.909-72.91c-33.625,0-61.911,22.757-70.335,53.719
				...
				<path
					className="st0"
					d="M315.584,357.793c-2.744-1.1-5.862,0.238-6.963,2.982c-0.951,2.37-2.211,4.313-3.736,5.964
